...
def main():
    parser = argparse.ArgumentParser(
        description="Compare two text files and save results."
    )
    ...
    parser.add_argument(
        "--same", default="same.txt", help="Output file for common lines"
    )
    parser.add_argument(
        "--diff", default="diff.txt", help="Output file for different lines"
    )
